...
"SELECT projects.category, SUM(pledges.aount) FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.category HAVING projects.category = 'book';"
end
